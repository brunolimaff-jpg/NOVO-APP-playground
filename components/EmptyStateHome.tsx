      ...
      <div className="max-w-3xl mx-auto px-4 pt-4 md:pt-8">
        ...
        <div className={`w-full max-w-2xl mx-auto mb-8 rounded-2xl border p-5 md:p-6 ${
          ...
          <div className="space-y-2.5 mb-5">
            {[
              { letter: 'P', label: 'Porte', desc: 'Massa crítica de negócio' },
              { letter: 'O', label: 'Operação', desc: 'Arquitetura da cadeia de valor' },
              { letter: 'R', label: 'Retorno', desc: 'Pressão externa (regulatório)' },
              { letter: 'T', label: 'Tecnologia', desc: 'Stack + dor + liberdade de troca' },
              { letter: 'A', label: 'Adoção', desc: 'Cultura + timing/janela' },
